...
insert into universidad values(1, 'UCV', 'desc UCV', '01/10/2022', 'UCV');
...
insert into evento values(1, 1, 'Evento1', '01/01/2022', '01/02/2022', 'Artes');
insert into evento values(2, 2, 'Evento2', '01/01/2022', '01/02/2022', 'Salud');
insert into evento values(3, 1, 'Evento3', '01/01/2022', '01/02/2022', 'Artes');
insert into evento values(4, 3, 'Evento4', '01/01/2022', '01/02/2022', 'Artes');

insert into empresa values(1, 'emp1', 'desc1', '042411111', 0);
...
insert into patrocina values(1, 1, 1, 1000, '05/10/2022');
insert into patrocina values(2, 4, 1, 1000, '05/10/2022');
insert into patrocina values(3, 1, 2, 2000, '06/10/2022');
insert into patrocina values(4, 2, 2, 3000, '06/10/2022');
